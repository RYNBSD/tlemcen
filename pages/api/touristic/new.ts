...
const newItem = async (
    ...
    try {
        ...
        const insertEnglishHistory = `
            INSERT INTO touristicen (title, description, link_to_read_more, image, map_source, map_link, location, category, status) VALUES ('${english.titleEN}', '${english.descriptionEN}', '${english.linkToReadMore}', '${english.image}', '${english.mapSource}', '${english.mapLink}', '${english.locationEN}', '${english.categoryEN}', ${english.status})
        `;

        const insertArabicHistory = `
            INSERT INTO touristicar (title, description, link_to_read_more, image, map_source, map_link, location, category, status) VALUES ('${arabic.titleAR}', '${arabic.descriptionAR}', '${english.linkToReadMore}', '${english.image}', '${english.mapSource}', '${english.mapLink}', '${arabic.locationAR}', '${arabic.categoryAR}', ${english.status})
        `;
